...
<head>
        ...
        <body>
			...
			if ($_GET["e1"]==$_GET["e2"]){
				...
				if ((($_GET["e1"]=="Rocaparda Village Sporting Club") and  ($_GET["e2"]=="North Pallerola Athletic Club")) or (($_GET["e1"]=="North Pallerola Athletic Club") and  ($_GET["e2"]=="Rocaparda Village Sporting Club"))){
